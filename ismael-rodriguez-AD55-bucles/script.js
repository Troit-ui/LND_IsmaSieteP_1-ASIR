...
// tenemos que inicializar la variable que usaremos en el bucle
let opcion = 33;
//Ponemos en pantalla las opciones del menú y con ello recogeremos una variable para el switch

while (opcion !== 5) {
    opcion = parseInt(prompt(`Elige una opción del menú
    ...
    switch (opcion) {
        ...
        case 2:
            ...
            break
        // En el caso 3 vamos a listar uno por uno los contactos gracias a "for of" ya que es más simple
        case 3:
            if (contactos.length > 0) {
                for (let contacto of contactos) {
                    console.log(contacto.nombre, contacto.telefono, contacto.email)
                } 
            ...
            break
        // EN el caso 4 pediremos por pantalla los datos de un nuevo contacto para añadirlo y de paso se muestre el último que se ha puesto y se ha puesto que ninguno de los tres campos pueda ser nulo
        case 4:
        ...
        default:
            alert("No se vale la opción,ponga una válida")
            break;
    }
}
console.log(opcion)